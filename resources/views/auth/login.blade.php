                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input name="email" type="text" required value="{{old('email')}}" autocomplete="username" required autofocus
                        ...
                        <div class="mt-8">
                            <label class="text-gray-800 text-xs block mb-2">{{ __('Password') }}</label>
                            <div class="relative flex items-center">
